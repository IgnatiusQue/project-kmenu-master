...
$(' <div class="dropright"><span class="dropdown-item"  data-toggle="dropdown" style="cursor:pointer;">'+menu.items[i].html+'&nbsp; <i class="fa fa-caret-right float-right"></i> </span><ul id="'+menu.items[i].id+'" class="dropdown-menu" style="padding:0!important;"></ul></div>').appendTo("#"+menu.id);
